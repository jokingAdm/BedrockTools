...
const std::array<SignatureDefinition, SignatureCount> definitions{{
    ...
    SignatureDefinition{SignatureId::NativeSuspendGameplayUpdates, "5F 1C 00 72 88 20 05 90 E9 07 9F 1A 09 E1 32 39"},
    ...
    SignatureDefinition{SignatureId::ActorShaderManagerSetEntityConstants, "09 A8 41 A9 44 00 40 BD EE 03 40 F9 28 19 40 F9 4B 19 40 F9 04 01 00 BD 44 04 40 BD 04 05 00 BD 44 08 40 BD 04 09 00 BD 44 0C 40 BD 04 0D 00 BD 28 00 80 52 64 00 40 FD 28 A5 00 39 64 01 00 FD"},
    SignatureDefinition{SignatureId::ActorShaderManagerSetupShaderParametersActorGlint, "FF 43 07 D1 EF 3B 13 6D ED 33 14 6D EB 2B 15 6D E9 23 16 6D FD 7B 17 A9 FC 6F 18 A9 FA 67 19 A9 F8 5F 1A A9 F6 57 1B A9 F4 4F 1C A9 FD C3 05 91 E1 0B 0C 2D 8C 40 20 1E F9 03 07 AA E0 5F 00 BD"},
    SignatureDefinition{SignatureId::ActorShaderManagerSetupFoilShaderParameters, "EA 0F 1A FC E9 A3 00 6D FD FB 01 A9 F9 17 00 F9 F8 5F 03 A9 F6 57 04 A9 F4 4F 05 A9 FD 63 00 91 F7 03 00 AA 00 58 40 F9 F4 03 04 AA F3 03 03 AA F5 03 02 AA F6 03 01 AA ? ? ? ? 08 7D 80 52"},
    SignatureDefinition{SignatureId::ActorShaderManagerSetupShaderParametersGlint, "08 10 40 F9 04 F6 03 4F 05 F6 03 0F 0A AD 4D A9 49 19 40 F9 6C 19 40 F9 24 01 80 3D 29 00 80 52 49 A5 00 39 85 01 00 FD 0A 75 40 F9 69 A5 00 39 4C 19 40 F9 9F 7D 00 A9 0B 69 40 F9 24 00 40 BD"},
    ...
    SignatureDefinition{SignatureId::SynchedActorDataEnsureIndex, "FD 7B BA A9 FC 6F 01 A9 FA 67 02 A9 F8 5F 03 A9 F6 57 04 A9 F4 4F 05 A9 FD 03 00 91 14 68 40 A9 37 3C 00 12 55 03 14 CB BB FE 43 93 FF 22 3B 6B 02 01 00 54 F4 4F 45 A9 F6 57 44 A9 F8 5F 43 A9"},
    SignatureDefinition{SignatureId::ActorSynchedDataUpdateAlwaysShowNameTag, "FF 03 01 D1 FD 7B 01 A9 F6 57 02 A9 F4 4F 03 A9 FD 43 00 91 54 D0 3B D5 F3 03 00 AA E0 03 01 AA 88 16 40 F9 21 0A 80 52 E8 07 00 F9 D5 A1 FF 97 08 1C 00 72 F5 07 9F 1A 1F FD 03 71 60 09 00 54"},
    SignatureDefinition{SignatureId::PrimedTntNormalTick, "FD 7B BD A9 F5 0B 00 F9 F4 4F 02 A9 FD 03 00 91 09 08 40 F9 AA 92 92 52 F3 03 00 AA AA 76 BD 72 2B A1 43 A9 08 01 0B CB 08 FD 43 D3 08 05 00 51"},
